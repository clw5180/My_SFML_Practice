...
void Animation::update(sf::Time dt)
{
	...
	sf::Vector2i textureBounds(mSprite.getTexture()->getSize());  //{1024, 1024}
	sf::IntRect textureRect = mSprite.getTextureRect();   //left=0 top=0 width=1024 height=1024，可以理解为xywh，也就是COCO格式的bbox...


	if (mCurrentFrame == 0)
		textureRect = sf::IntRect(0, 0, mFrameSize.x, mFrameSize.y);  // 256, 256
